...
%	\setlength{\grammarindent}{12em} % increase separation between LHS/RHS 
	...
	\begin{grammar}
		...
		<unsigned odd number> ::= <odd digit> | <natural number> <unsigned odd number>
	...
	\begin{grammar}
		...
		<unsigned even number> ::= <even digit> | <natural number> <unsigned even number>
	...
	\begin{grammar}
		...
		<unsigned int div-by-5> ::= 0 | 5 | <natural number> <unsigned int div-by-5>
