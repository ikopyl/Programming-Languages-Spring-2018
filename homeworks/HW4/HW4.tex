...
\paragraph{(1.a) Show an example of the anonymous function and its use.}\
\paragraph{}\
...
\paragraph{}\
\paragraph{(1.b) Show examples of defining and using named functions.}\
\paragraph{}\
...
\paragraph{}\
\paragraph{(1.c) Show an example of a data structure (e.g. a list) that contains functions.}\
\paragraph{}\
...
\paragraph{}\
\paragraph{(1.d) Show an example of comparing functions and lists for equality.}\
\paragraph{}\
...
\paragraph{}\
\paragraph{(1.e) Show an example of passing function as an argument to another function.}\
\paragraph{}\
...
\paragraph{}\
\paragraph{(1.f) Show an example of returning a function as a result of another function.}\
\paragraph{}\
...
\paragraph{}\
\paragraph{(1.g) Show examples of reading function(s) from the keyboard, reading function(s) from a file, and displaying a function.}\
...
\paragraph{3. (a) Write a recursive Scheme procedure line that prints n asterisks in a line as follows:}\
