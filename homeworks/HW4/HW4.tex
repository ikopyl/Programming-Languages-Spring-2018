...
\newline
\newline
At the very basic case, an anonymous function is nothing more but a lambda expression - a body of a function. Since it is not associated with any identifier (i.e. when it is unnamed), we may use it only once - when we explicitly use it in other expressions:
\ttfamily
