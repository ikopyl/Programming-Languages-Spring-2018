...
class Sphere
  ...
  def show
    p self
    puts "Radius of sphere is #{@radius}"
    puts "Area of sphere is #{format('%.4f', area)}"
    puts "Volume of sphere is #{format('%.4f', volume)}"
    puts
  end
...
class Ball < Sphere
  ...
  def show
    p self
    puts "Color of the Ball is #{@color}"
    puts "Radius of the Ball is #{@radius}"
    puts "Area of the Ball is #{format('%.5f', area)}"
    puts "Volume of the Ball is #{format('%.5f', volume)}"
    puts
  end
...
class MyBall < Ball
  ...
  def show
    p self
    puts "Owner of MyBall is #{@owner}"
    puts "Color of MyBall is #{@color}"
    puts "Radius of MyBall is #{@radius}"
    puts "Area of MyBall is #{format('%.6f', area)}"
    puts "Volume of MyBall is #{format('%.6f', volume)}"
    puts
  end
...
# for sphere with radius #3 area is equal to volume
sphere = Sphere.new(3)
sphere.show
...
ball = MyBall.new(1, 'green', 'Mr. Peanutbutter')
ball.show

ball.owner = 'Bojack Horseman'
ball.show
\end{minted}
...
\begin{minted}[fontsize=\small]{csh}
